...
public class PersonInfo {
    ...
    public String getsBnkAccountNumber() {
        return sBnkAccountNumber;
    }

    public void setsBnkAccountNumber(String sBnkAccountNumber) {
        this.sBnkAccountNumber = sBnkAccountNumber;
    }
